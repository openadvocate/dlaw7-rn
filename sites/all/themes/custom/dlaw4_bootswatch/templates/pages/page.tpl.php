 ...
 */
?>
<?php if (!empty($methyl_yellow_unpubllished)): ?>
    <?php print $methyl_yellow_unpubllished ?>
<?php endif; ?>
                ...
                <div class="name-container">
                  <div class="site-name-slogan<?php // print $class; ?>">
                      ...
                      <?php if (!empty($site_name)): ?>
                        <?php if (drupal_is_front_page()): // Use <h1> instead of <div> ?>
                          <h1 id="the-title" class="site-title"><?php print l( $site_name, '', array('attributes' => array('class' => array('site-title-link')))); ?></h1>
                        <?php else: ?>
                          <div id="the-title" class="site-title"><?php print l( $site_name, '', array('attributes' => array('class' => array('site-title-link')))); ?></div>
                        <?php endif; ?>
                      <?php endif; ?>
...
<?php if ($is_front): ?> <!-- Front page Test-->
  <?php if (empty($mission_background_state)): ?>
    <?php
...
<?php if ($is_front): ?> <!-- Front page Test-->
  ...
  <?php if (!empty($darken)): ?>
    <?php $overlay_classes = " enable_overlay"; ?>
  <?php endif ?>

  <?php if (!empty($diffuse)): ?>
    <?php $diffuse_classes = " enable_diffuse"; ?>
  <?php endif ?>

  <div class="mission_background_container" style="">
    <div class="mission_background" >
  <?php else: ?>
  <div class="container">
    <div class="">
  <?php endif ?>

  <div class="mission_background_img <?php echo !empty($diffuse_classes) ? $diffuse_classes : ''; ?>" style=" background-color: #444; background-image: url(<?php echo $mission_background; ?>);" ></div>
  <div class="overlay_container <?php echo !empty($overlay_classes) ? $overlay_classes : ''; ?>"></div>
  ...
  <div class="container">
    ...
    <?php if (!empty($mission) || !empty($missionbg_search)): ?>
      ...
      <div class="text-center">
        ...
        <?php endif; ?>
        <?php if ($missionbg_search_position != 'none'): ?>
          <div style="position: relative;">
            <?php print $missionbg_search; ?>
          </div>
        <?php endif; ?>
      </div>
    <?php endif ?>
